...
<head>
    ...
    <script>
        ...
        ( function ( d ) {
            ...
            wf.src = 'public/ui/frontend/js/webfont.js';
            wf.async = true;
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('ui/frontend')}}/css/demo27.min.css">
    ...
    <div class="mobile-menu-wrapper">
        ...
        <div class="mobile-menu-container scrollable">
            ...
            <ul class="mobile-menu mmenu-anim">
                ...
                <li>
                    <a href="element-products.html">Elements</a>
                    <ul>
                        <li>
                            <a href="#">Elements 1</a>
                            <ul>
                ...
                <li><a href="https://d-themes.com/buynow/riode.html">Buy Riode!</a></li>
            </ul>
            <!-- End MobileMenu -->
        </div>
    </div>
